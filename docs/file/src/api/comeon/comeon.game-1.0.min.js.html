...
<head>
  ...
  <title data-ice="title">src/api/comeon/comeon.game-1.0.min.js | comeon-javascript-test</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">src/api/comeon/comeon.game-1.0.min.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">const jQuery = require(&apos;jquery&apos;);
